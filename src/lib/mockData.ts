import { User, Document, IngestionJob, Question, DocumentExcerpt } from '@/types';
  ...
  '1': [
    {
      ...
      documentId: '1',
      documentTitle: 'Annual Report 2023',
      content: 'Revenue increased by 15% year-over-year, reaching $120 million in 2023.',
      relevanceScore: 0.92,
    },
    {
      id: '102',
  ...
  '2': [
    {
      ...
      documentId: '2',
      documentTitle: 'Product Specifications',
      content: 'The new model features 50% improved battery life compared to the previous generation.',
      relevanceScore: 0.94,
    },
    {
      id: '202',
      documentId: '2',
      documentTitle: 'Product Specifications',
      content: 'All components are manufactured using recycled materials to reduce environmental impact.',
      relevanceScore: 0.88,
    },
  ],
};
...
export const mockQuestions: Question[] = [
  {
    ...
    answer: 'According to the 2023 Annual Report, revenue increased by 15% year-over-year, reaching $120 million in 2023.',
  ...
  },
  {
    ...
    answer: 'The new model features 50% improved battery life compared to the previous generation. Additionally, all components are manufactured using recycled materials to reduce environmental impact.',
