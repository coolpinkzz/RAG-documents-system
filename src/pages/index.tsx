  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        // const [documentsResponse, ingestionResponse] = await Promise.all([
        //   fetchWithAuth<Document[]>('/documents?limit=5'),
        //   fetchWithAuth<IngestionJob[]>('/ingestion/jobs?limit=3'),
        // ]);
        
        // For now, use the mock data
        await new Promise(resolve => setTimeout(resolve, 500)); // Simulate API delay
        setDocuments(mockDocuments.slice(0, 3));
              ...
              <div className="flex flex-col md:flex-row items-center justify-between">
                <div className="mb-4 md:mb-0">
                  ...
                  <p className="text-gray-600 mt-1">
                    Manage your documents and access the Q&A interface from your dashboard.
                  </p>
                </div>
                  ...
                  {ingestionJobs.map((job) => (
                    <div key={job.id} className="p-3 border rounded-md">
                      <div className="flex justify-between items-center mb-2">
                        <h3 className="font-medium text-gray-900 text-sm truncate" title={job.documentTitle}>
                          {job.documentTitle}
                        </h3>
